	...
	<view class="content" :class="readerSettings.theme" style="transition: all .5s;">
		...
		ref="tools">
			<div class="settings" :class="{opened: settingsOpened}" ref="settings">
				...
				<div class="line">
					<div class="button white theme" @click="changeTheme('white')" :class="{'selected':readerSettings.theme == 'white'}">蛙鸣白</div>
		...
		<div class="title" :style="{fontSize:readerSettings.titleFontSize + 'rpx'}"
...
<!-- 		<div class="underBar">
		...
		<articleTools :article="article" v-if="this.article.article_id"></articleTools>
					...
					IDBOpenDBRequest.onsuccess = function(e){
						...
						request.onsuccess = function( event) {
							if(request.result){
								...
								_this.article.content = request.result.article_content;
