...
var render = function render() {
  ...
  }, [_vm._ssrNode("<div class=\"login-box\" data-v-22560504>", "</div>", [_vm._ssrNode("<div class=\"login-header\" data-v-22560504><img" + _vm._ssrAttr("src", __webpack_require__(51)) + " alt style=\"width: 100px; margin-bottom: 20px;\" data-v-22560504> <h1 data-v-22560504>原木社区</h1> <p data-v-22560504>方块跃然纸上，故事在此生长。</p></div> " + (_vm.step == 0 ? "<div class=\"login-step\" data-v-22560504><p class=\"step-tip\" data-v-22560504>未注册邮箱将自动创建账号</p> <div class=\"input-group\" data-v-22560504><div class=\"input-icon\" data-v-22560504><img" + _vm._ssrAttr("src", __webpack_require__(102)) + " alt=\"用户\" class=\"icon\" data-v-22560504></div> <input type=\"email\" placeholder=\"请输入电子邮箱\"" + _vm._ssrAttr("value", _vm.email) + " class=\"login-input\" data-v-22560504></div> <button class=\"login-btn\" data-v-22560504>下一步</button></div>" : "<!---->") + " "), _c('transition', {
    attrs: {
      "name": "fade"
    }
  }, [_vm.step == 1 ? _c('div', {
