...
module.exports.__inject__ = function (context) {
  add("6ad73c85", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_fans_vue_vue_type_style_index_0_id_3681e4d4_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(127);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_fans_vue_vue_type_style_index_0_id_3681e4d4_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_fans_vue_vue_type_style_index_0_id_3681e4d4_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_fans_vue_vue_type_style_index_0_id_3681e4d4_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_fans_vue_vue_type_style_index_0_id_3681e4d4_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/novel/fans.vue?vue&type=template&id=3681e4d4&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "fans-page"
  }, [_vm._ssrNode("<div class=\"page-header\" data-v-3681e4d4>", "</div>", [_c('nuxt-link', {
  ...
  }, [_vm._v("←")]), _vm._v(" 返回书库\n    ")]), _vm._ssrNode(" <h1 class=\"page-title\" data-v-3681e4d4>" + _vm._ssrEscape(_vm._s(_vm.novel.name) + " - 粉丝榜") + "</h1>")], 2), _vm._ssrNode(" "), _vm.loading ? _vm._ssrNode("<div class=\"loading-container\" data-v-3681e4d4>", "</div>", [_vm._ssrNode("<div class=\"loading-spinner\" data-v-3681e4d4></div> <p data-v-3681e4d4>正在加载粉丝榜...</p>")], 2) : _vm.error ? _vm._ssrNode("<div class=\"error-container\" data-v-3681e4d4>", "</div>", [_vm._ssrNode("<p data-v-3681e4d4>" + _vm._ssrEscape(_vm._s(_vm.error)) + "</p> "), _c('nuxt-link', {
    staticClass: "back-button",
    attrs: {
      "to": `/novel/${_vm.novelId}`
    }
  }, [_vm._v("返回小说详情")])], 2) : _vm._ssrNode("<div class=\"fans-container\" data-v-3681e4d4><div class=\"novel-info\" data-v-3681e4d4>" + (_vm.novel.picUrl ? "<div class=\"novel-cover\"" + _vm._ssrStyle(null, `background-image: url(${_vm.novel.picUrl})`, null) + " data-v-3681e4d4></div>" : "<div class=\"novel-cover\"" + _vm._ssrStyle(null, `background-color: hsl(${_vm.novel.novel_id * 30 % 360}, 70%, 80%)`, null) + " data-v-3681e4d4></div>") + " <div class=\"novel-details\" data-v-3681e4d4><h2 class=\"novel-title\" data-v-3681e4d4>" + _vm._ssrEscape(_vm._s(_vm.novel.name)) + "</h2> <div class=\"novel-author\" data-v-3681e4d4>" + (_vm.novel.auther_avatar ? "<img" + _vm._ssrAttr("src", _vm.novel.auther_avatar) + " alt=\"作者头像\" class=\"author-avatar\" data-v-3681e4d4>" : "<div class=\"author-avatar-placeholder\" data-v-3681e4d4>" + _vm._ssrEscape(_vm._s(_vm.novel.author_name ? _vm.novel.author_name.charAt(0) : '作')) + "</div>") + " <span class=\"author-name\" data-v-3681e4d4>" + _vm._ssrEscape(_vm._s(_vm.novel.author_name || '佚名')) + "</span></div></div></div> <div class=\"fans-list-container\" data-v-3681e4d4><h3 class=\"section-title\" data-v-3681e4d4>原木力榜 - 粉丝贡献排行</h3> <div class=\"fans-list\" data-v-3681e4d4>" + _vm._ssrList(_vm.fansList, function (fan, index) {
    return "<div class=\"fan-item\" data-v-3681e4d4><div class=\"fan-rank\" data-v-3681e4d4><div" + _vm._ssrClass(null, index <= 2 ? _vm.rankClasses[index] : 'rank-number') + " data-v-3681e4d4>" + _vm._ssrEscape(_vm._s(index + 1)) + "</div></div> <div class=\"fan-avatar\" data-v-3681e4d4><img" + _vm._ssrAttr("src", fan.avatar_url) + " alt=\"头像\" data-v-3681e4d4></div> <div class=\"fan-details\" data-v-3681e4d4><div class=\"fan-info\" data-v-3681e4d4><span class=\"fan-name\" data-v-3681e4d4>" + _vm._ssrEscape(_vm._s(fan.user_name)) + "</span> <span class=\"fan-value\" data-v-3681e4d4>" + _vm._ssrEscape(_vm._s(fan.fans_value)) + "</span></div> <div class=\"fan-message\" data-v-3681e4d4>\n              此书只应天上有，当赏当赏！\n            </div></div></div>";
  }) + "</div></div> " + (_vm.isLogin && _vm.myInfo.name ? "<div class=\"my-info-wrapper\" data-v-3681e4d4><div class=\"my-info-rank\" data-v-3681e4d4>" + _vm._ssrEscape("\n        " + _vm._s(_vm.myInfo.rank) + "\n      ") + "</div> <div class=\"my-info\" data-v-3681e4d4><div class=\"my-avatar\" data-v-3681e4d4><img" + _vm._ssrAttr("src", _vm.myInfo.avatar_url) + " alt=\"我的头像\" data-v-3681e4d4></div> <div class=\"my-details\" data-v-3681e4d4><span class=\"my-name\" data-v-3681e4d4>" + _vm._ssrEscape(_vm._s(_vm.myInfo.name)) + "</span> <span class=\"my-value\" data-v-3681e4d4>" + _vm._ssrEscape(_vm._s(_vm.myInfo.fans_value)) + "</span></div></div></div>" : "<!---->") + "</div>")], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/novel/fans.vue?vue&type=template&id=3681e4d4&scoped=true
